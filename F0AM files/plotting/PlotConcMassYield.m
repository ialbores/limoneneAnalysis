function PlotConcMassYield(M2Plot, S, n2plot)
...
Time = S.Time;
XnamesAll = Xnames;
deltaPrecursor = S.Conc.LIMONENE(1)- S.Conc.LIMONENE;
...
plot(deltaPrecursor,X2plot,'LineWidth',2)
...
ylabel('ppb')
xlabel('dLIMONENE')
xlim([min(deltaPrecursor) max(deltaPrecursor)])
purtyPlot
